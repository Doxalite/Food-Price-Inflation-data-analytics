...
#################################### load data ####################################
    ...
    conversion_factor = cpi_sg_data_filtered.loc[cpi_sg_data_filtered['date'] == dt.datetime(2024, 12, 1), 'CPI_SG'].values[0] / 100
    conversion_factor
    ...
    # change base year to 2024-12 = 100
    conversion_factor_us_cpi = merged_us_price_data_filtered.loc[merged_us_price_data_filtered['date'] == dt.datetime(2024, 12, 1), 'CPI_US'].values[0] / 100
    ...
    income_us_data_filtered = income_us_data.loc[:, ['date', 'median_income_per_household_member_US']]
